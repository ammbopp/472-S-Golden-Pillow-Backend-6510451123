...
twn — 7/2/68 12:12
CREATE TABLE Coupon (
    discount_details VARCHAR(20) NOT NULL,
    coupon_code VARCHAR(13) UNIQUE NOT NULL,
...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2025 at 04:24 AM
ขยาย
users (1).sql
4 KB
-- phpMyAdmin SQL Dump
...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2025 at 04:23 AM
ขยาย
deliveredorders.sql
3 KB
DB ที่ใช้ในการทำงานส่วนของเราคับบ อยากจะให้ลองเอาไปลงในเครื่องแต่ละคนแล้วรัน  test ให้หน่อยคับ
เพราะตอนนี้คิดว่าน่าจะรันเทสไม่ผ่านเพราะแค่ข้อมูลไม่ตรงกันอย่างเดียวแล้วรึป่าวนะ
บี-บี — 24/3/68 14:14
ของนี่ค้าบ
-- phpMyAdmin SQL Dump
-- version 5.2.1
...
--
-- Host: localhost
-- Generation Time: Mar 24, 2025 at 08:13 AM
ขยาย
reviews.sql
3 KB
ถ้ารันแล้วไม่ผ่าน (เคยรันไปแล้ว รบกวนลบ record ตามนี้ก่อนรันอีกครั้งนะคับ) ตาราง review, order
ภาพ
ภาพ
twn — 24/3/68 17:58
ของคูปองนะคับ
...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2025 at 11:57 AM
ขยาย
coupon.sql
3 KB
(ตอน test ส่วนที่เป็น create จะไม่ผ่านนะคะ ต้องไปเปลี่ยนตัว coupon_code ใน .feature เพราะว่าพอรันเทสปุ๊ป มันจะสร้างของจริง แล้วพอรันอีกครั้งจะกลายเป็นว่า coupon_code มันซ้ำกันคับ) 
มิ้ม — 24/3/68 18:10
มันสามารถจัดการได้ด้วยการเขียนให้มันลบใน step_definition ได้ไหมนะคับ
เช่นก่อนรันอีกอันให้ลบก่อนมันจะได้ไม่ซ้ำแล้วจะได้ไม่ขึ้น fail
twn — 24/3/68 18:12
ของคูปองมันไม่มีลบอะคับ มีแค่เปลี่ยนสถานะ
หรือผมสร้างเพิ่มไว้แค่สำหรับเทสดีนะ
scherzysan — 24/3/68 18:15
สร้างไว้ก้ได้คั้บ
twn — 24/3/68 18:16
อะเคคับ
scherzysan — 24/3/68 19:27
INSERT INTO users (
  user_id, username, name, lastname, phone_number, role, 
  password, email, address, house_details, name_road, 
...
(47, 'Bob123456', 'Bob', 'Builder', '0123456789', 'packaging staff', 'password', 'bob@gmail.com', 'asdsad', '', 'adssadsa', 'asdsada', 'asdsada', '10901'),
(193, 'Sherlock', 'Sherlock', 'Holmes', '0123456789', 'delivering staff', 'password', 'bob@gmail.com', '221B', '', '6XE UK', 'Baker Street', 'London', '10900');
INSERT INTO orders (
  order_id, user_id, total_price, delivery_status, 
  payment_status, status_for_ledger, packed_status, 
  slip_payment, order_date
) VALUES

(51, 8, 1850, 'sent the packet', 'Approved', 'not done', 'packed', '/images/image-1739808610731-255562329.jpg', '2025-02-08 13:09:48'),
(52, 1, 1700, 'yet to send', 'Approved', 'not done', 'packed', '/images/image-1739022399466-579866125.jpg', '2025-02-10 22:46:23'),
(53, 1, 600, 'yet to send', 'Yet to check', 'not done', 'not packed yet', '/images/image-1740401736684-321099819.jpg', '2025-02-24 19:55:32'),
(54, 1, 3300, 'sent the packet', 'Approved', 'not done', 'packed', '/images/image-1740407900475-629183215.jpg', '2025-02-24 22:08:16'),
(999, 1, 12700, 'sent the packet', 'Approved', 'not done', 'packed', 'no path', '2025-03-10 19:37:39');
บี-บี — 24/3/68 19:48
ภาพ
twn — 24/3/68 19:50
ภาพ
...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2025 at 03:57 PM
ขยาย
orderline.sql
3 KB
scherzysan — 01:34
